...
namespace BusinessEntities
{
    ...
    public partial class CLIt03_atencion
    {
        ...
        public CLIt03_atencion()
        {
            ...
            this.CLIt08_funciones_vitales = new HashSet<CLIt08_funciones_vitales>();
            this.CLIt09_anamnesis = new HashSet<CLIt09_anamnesis>();
            this.CLIt10_examen_fisico = new HashSet<CLIt10_examen_fisico>();
            this.CLIt11_estudio_complementario = new HashSet<CLIt11_estudio_complementario>();
            this.CLIt13_laboratorio = new HashSet<CLIt13_laboratorio>();
            this.CLIt17_tratamiento = new HashSet<CLIt17_tratamiento>();
            this.CLIt15_diagnostico = new HashSet<CLIt15_diagnostico>();
            this.CLIt18_evolucion = new HashSet<CLIt18_evolucion>();
        }
